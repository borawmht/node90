...
if __name__ == "__main__":
    ...
    # print(f"Result: {result}")
    # result = get(node_ip, '/inx/sensors/WallSwitch', 5)
    # print(f"Result: {result}")
    # result = get(node_ip, '/inx/sensors/sensor1/context', 5)
    # print(f"Result: {result}")
    # result = get(node_ip, '/inx/sensors/WallSwitch/context', 5)
    # print(f"Result: {result}")
    # result = get(node_ip, '/inx/sensors', 5)
    # print(f"Result: {result}")
